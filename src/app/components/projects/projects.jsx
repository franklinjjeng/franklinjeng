  ...
  render() {
    ...
    var projects = [
      ...
      },
      {
        ...
        link: 'N/A',
        description: 'Healthwars was based on an exercise competition. Every week there would be an exercise assigned that will give you points. The person with the most points will win a prize. The app was created to digitize and better track the achievements and exercises done.',
        contribution: 'I created and maintained the project structure to streamline organization and flow of the development process. I built front end components to allow users to track their progress on their exercises within the profile as well as components to log exercise information. Created the API calls to the backend to pull as well as store information on the database.',
        challenges: 'the challenges'
      },
      {
